...
# %%
proxies_list = ['45.149.83.4:62766', '45.137.53.101:64294',
                '195.208.168.221:64546', '195.208.127.27:64256',
                '195.208.126.128:64878', '46.3.150.68:64800',
                '138.124.79.157:64682', '5.189.249.66:63044', '45.147.246.91:64994',
...
# %%
def get_rn_async_proxy(proxies_list, authenticators):
...
async def book_downloader(bookpage: BookPage, conn):
    if bookpage.book_check() is not None:
        print(f'{bookpage.book_index} book is empty')
    else:
        try:
            await conn.execute('insert into book_data (site_index, book_name, author, rating, nb_ratings, nb_reviews, nb_5_stars, nb_4_stars, nb_3_stars, nb_2_stars, nb_1_stars, genres, series_name, description, nb_pages, publication_date, awards) '
                               ...
                               bookpage.book_index, bookpage.book_data()[0], bookpage.book_data()[1],
                               bookpage.book_data()[2],
                               bookpage.book_data()[3],
                               bookpage.book_data()[4], bookpage.book_data()[5], bookpage.book_data()[6],
                               bookpage.book_data()[7],
                               bookpage.book_data()[8],
                               bookpage.book_data()[9], bookpage.book_data()[10], bookpage.series(),
                               bookpage.description_data(),
                               bookpage.pages_date_data()[0], bookpage.pages_date_data()[1], bookpage.awards_data())
            print(f'{bookpage.book_index} was downloaded successfully')
        except asyncpg.exceptions.PostgresError as e:
            print(e)
        except AttributeError as ae:
            print(ae, bookpage.book_index)
        ...
        async with httpx.AsyncClient(transport=httpx.AsyncHTTPTransport(proxy=proxy), follow_redirects=True,
            ...
            for coro in asyncio.as_completed(coros):
                ...
                if isinstance(bookpage, tuple):
                    ...
                    print(f'Request problem with book {bookpage[1]}')
                    continue
...
#%%
extract_books(tupler(105000, 110000, 10))
